...
- [ ] T001 Create frontend directory and navigate to it
- [ ] T002 Initialize Next.js project with App Router, TypeScript, Tailwind CSS, ESLint using npx create-next-app@latest --typescript --tailwind --eslint --app --src-dir --import-alias "@/*"
- [ ] T003 Install core dependencies: next, react, react-dom, typescript, tailwindcss
- [ ] T004 Install authentication dependencies: better-auth, better-auth/react
- [ ] T005 Install UI dependencies: shadcn/ui, @radix-ui/react components, class-variance-authority, clsx, lucide-react, tailwind-merge, tailwindcss-animate
- [ ] T006 Install utility dependencies: react-hook-form, zod, @hookform/resolvers
- [ ] T007 Create .env.local file with environment variables (BETTER_AUTH_SECRET, BETTER_AUTH_URL, NEXT_PUBLIC_API_URL)
- [ ] T008 Configure Next.js to handle TypeScript and module resolution for @/* alias
- [ ] T009 Verify project structure matches plan.md specifications
...
- [ ] T010 [P] Initialize Shadcn/UI in the project using npx shadcn@latest init
- [ ] T011 [P] Add required Shadcn/UI components: button, input, card, table, dialog, checkbox, label, slot using npx shadcn@latest add
- [ ] T012 [P] Create src/types/index.ts with TypeScript interfaces for User, Todo Task, and API responses
- [ ] T013 Create centralized API client in src/lib/api.ts that automatically attaches JWT tokens to requests
- [ ] T014 Implement error handling and response parsing in the API client
- [ ] T015 Set up Better Auth configuration in src/lib/auth.ts
- [ ] T016 Create custom hook src/hooks/use-auth.ts for authentication state management
- [ ] T017 Create src/lib/utils.ts with utility functions for the application
- [ ] T018 Test that API client can make requests with mock data
...
- [ ] T019 [P] [US1] Create login page at src/app/(auth)/login/page.tsx
- [ ] T020 [P] [US1] Create signup page at src/app/(auth)/signup/page.tsx
- [ ] T021 [P] [US1] Create login form component at src/components/auth/login-form.tsx with validation
- [ ] T022 [P] [US1] Create signup form component at src/components/auth/signup-form.tsx with validation
- [ ] T023 [US1] Implement form validation using React Hook Form and Zod for login form
- [ ] T024 [US1] Implement form validation using React Hook Form and Zod for signup form
- [ ] T025 [US1] Connect login form to authentication API endpoint
- [ ] T026 [US1] Connect signup form to registration API endpoint
- [ ] T027 [US1] Handle authentication errors and display appropriate messages
- [ ] T028 [US1] Redirect authenticated users from auth pages to dashboard
- [ ] T029 [US1] Store JWT token securely in browser storage
...
- [ ] T033 [P] [US2] Create dashboard layout at src/app/dashboard/layout.tsx
- [ ] T034 [P] [US2] Create dashboard page at src/app/dashboard/page.tsx
- [ ] T035 [P] [US2] Create task list component at src/components/dashboard/task-list.tsx
- [ ] T036 [P] [US2] Create task form component at src/components/dashboard/task-form.tsx
- [ ] T037 [P] [US2] Create task item component at src/components/dashboard/task-item.tsx
- [ ] T038 [US2] Implement API calls to fetch tasks from GET /api/tasks endpoint
- [ ] T039 [US2] Display tasks in a responsive list format
- [ ] T040 [US2] Implement task creation via POST /api/tasks endpoint
- [ ] T041 [US2] Implement task updating via PUT /api/tasks/{taskId} endpoint
- [ ] T042 [US2] Implement task deletion via DELETE /api/tasks/{taskId} endpoint
- [ ] T043 [US2] Implement task completion toggle via PATCH /api/tasks/{taskId}/toggle endpoint
- [ ] T044 [US2] Add form validation to task creation/editing using React Hook Form and Zod
- [ ] T045 [US2] Handle API errors during task operations
...
- [ ] T047 [P] [US3] Create protected route component at src/components/protected-route.tsx
- [ ] T048 [US3] Implement authentication check in protected route component
- [ ] T049 [US3] Redirect unauthenticated users to login page
- [ ] T050 [US3] Preserve authentication state across page navigations
- [ ] T051 [US3] Implement session management with Better Auth
